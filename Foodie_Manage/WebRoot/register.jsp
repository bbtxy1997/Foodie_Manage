                ...
                <div class="index_header">
                    ...
                    <div class="signin">
                        <form class="form" name="signinForm" action="UserLoginServlet" method="post" onsubmit="return validateSignIn()">
                            <div><span class="name">用户名：</span><input type="text" name="username" placeholder="请输入用户名" id="username2"/></div>
                    ...
                    <div class="signup"  style="display: none;">
                        <form class="form" name="signupForm" action="UserRegisterServlet" method="post" onsubmit="return validateSignUp()">
                            ...
                            <div><span class="name">性别：</span><input type="radio" name="sex" value="男" checked="checked"/><span>男</span>
                            									<input type="radio" name="sex" value="女"/><span>女</span></div>
                            ...
                            <div><span class="name"></span><input type="submit" value="立即注册" name="submit"/></div>
                        </form>
                    </div>
                </div>
            </div>
