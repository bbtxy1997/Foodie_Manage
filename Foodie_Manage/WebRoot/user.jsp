<%@page import="com.qst.foodie.dao.UserInfoDAO"%>
<%@page import="com.qst.foodie.bean.User"%>
<%@page import="com.qst.foodie.bean.UserInfo"%>
...
<html lang="en">
    ...
    <body>
    	 <jsp:useBean id="user" class="com.qst.foodie.bean.User" scope="session"></jsp:useBean>
    	<%
    	UserInfoDAO dao = new UserInfoDAO();
    	UserInfo userInfo = dao.searchByUser(user);
